...
$.extend( $.validator, {
	...
	messages: {
		...
		number: "Ingrese una número válida.",
		digits: "Ingrese solamente dígitos.",
		creditcard: "Ingrese un número de tarjeta de credito válido.",
		equalTo: "Ingrese el valor nuevamente.",
		maxlength: $.validator.format( "Ingrese un valor no mayor a {0} caracteres." ),
		minlength: $.validator.format( "Ingrese un valor menor a {0} caracteres." ),
