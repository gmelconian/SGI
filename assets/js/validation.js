...
$(document).ready(function() {
    ...
    jQuery.validator.addMethod("greaterThan", function(value, element) {
        ...
        if (value < smaller) { return false; } else { return true; }
    ...
    jQuery.validator.addMethod("acceptImgExtension", function(value, element) {
        if (value == "") {
            ...
            if (extension == 'jpg' || extension == 'png' || extension == "jpeg" || extension == "gif") { return true; } else { return false; }
        }
    ...
    }, "Ingrese menos de 18 años de la fecha actual.");
