...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-bank"></i>Actualizar Edificio
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <form role="form" id="updateEdificio" action="<?php echo base_url().'updateEdificio/'. $edificio->codigo; ?>" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nombre *</label>
                                        <input type="text" class="form-control"  id="fname" placeholder="Nombre" name="fname" required  minlength="5" maxlength="50" pattern="[Aa-Zz]{1,15}"  value="<?php echo $edificio->nombre; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Ciudad *</label>
                                        <input type="text" class="form-control" id="ciudad" required name="ciudad" maxlength="30" minlength="1" pattern="[A-z]{2,30}" value="<?php echo $edificio->ciudad; ?>">
                                    </div>
                                </div> 
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Calle *</label>
                                    <input type="text" class="form-control" id="calle" required name="calle" maxlength="50" minlength="2" value="<?php echo $edificio->calle; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Número *</label>
                                        <input type="number" class="form-control" id="numero" required name="numero" maxlength="10" value="<?php echo $edificio->numero; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row"> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Latitud *</label>
                                        <input type="number" step="any" class="form-control" id="latitud" required name="latitud" value="<?php echo $edificio->latitud; ?>"><br>
                                        <label>Longitud *</label>
                                        <input type="number" step="any" class="form-control" id="longitud"  required name="longitud" value="<?php echo $edificio->longitud; ?>"><br>
                                        ...
                                        <textarea class="form-control" rows="3" id="referencia" name="referencia"> <?php echo $edificio->referencia; ?></textarea><br>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function(){      
        document.getElementById("departamento").value = <?php echo $edificio->departamento ?>;
    });    
</script>
<script>
    mapa = {
