...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-bank"></i> Modificar contrato
        </h1>
    </section>
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Modificar detalles del contrato</h3>
                    </div>
                        ...
                        <div class="box-body">
                            <div id="" class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" readonly="readonly" class="form-control" id="tipo" name="tipo" value="<?php echo $tc ?>">
                                </div>
                            </div>
