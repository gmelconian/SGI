...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-Empresas"></i> Alta de Computadoras
        </h1>
    </section>
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Ingresar detalles de la computadora</h3>
                    </div>
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addComputadora" method="post" role="form">
                        <div class="box-body">
                            <!--divrow-->
                            <div class="col-md-2">                                
                                <div class="form-group">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-default" onclick="generaSerial()">Genera Serial</button>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="box-footer">
                                <input type="submit" class="btn btn-primary" onclick='Enviar()' value="Enviar">
...
<script language="javascript" type="text/javascript">
    ...
    function generaSerial(){
        var serial = "CLON" + Math.floor(100000 + Math.random() * 900000);
        var rowIndex = myAppendGrid.getRowCount();
        var dataString = {
            "serial" : serial
        };
        $.ajax({
            url: baseURL + "validaSerial",
            type:"POST",
            dataType: 'json',
            data: dataString,
            success: function(data){
                if(data="true"){
                    myAppendGrid.setCtrlValue("serial", rowIndex -1, serial);
                }    
            },
            error:function(){
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        window.myAppendGrid = new AppendGrid({
            ...
            {
                name: "host",
                display: "Nombre de Host",
            },
            {
                name: "servicio",
                display: "Nro de Servicio",
            },
            ],
        });
    });    
