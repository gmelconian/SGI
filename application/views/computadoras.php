...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-laptop"></i> Computadoras
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>creaComputadora"><i class="fa fa-plus"></i> Agregar Computadora</a>
                </div>
            </div>
            <?php } ?> 
        </div>
        <div class="row">
            <div class="col-xs-12"> 
                <div class="box">
                    <h3 class="box-title"> &nbsp Lista de computadoras</h3>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover nuevaTable table-bordered" id="tabla">
                                    ...
                                    <?php if(!empty($computadoras)){
                                            foreach($computadoras as $record){ ?>
                                                <tr>
                                                    <td class="text-center">
                                                        <img  id="qr" name="qr" alt="qr" src="<?php 
                                                            $texto = str_replace('COM' , 'min_COM' , $record->qr );
                                                            echo $texto; 
                                                        ?>">
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ((permiso(2)|| permiso(3))&& $record->estado!="DESECHADO") {?> 
                                                            ...
                                                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'editaComputadora/'.$record->codigo; ?>" title="Editar"><i class="fa fa-pencil"></i></a>
                                                            <?php if ($record->estado!="NUEVA"){?>
                                                                <a class="btn btn-sm btn-success" href="<?php echo base_url().'CHestadoEquipo/'.$record->codigo."/pc"; ?>" title="Cambiar Estado"><i class="fa fa-refresh"></i></a>
                                                        <?php }} if (permiso(2)) {?>     
