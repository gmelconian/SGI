...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-Empresas"></i> Edición de Impresoras
        </h1>
    </section>
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Ingresar detalles de la impresora</h3>
                    </div>
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addEquipos" action="<?php echo base_url() .'updateEquipos/'.$equipo->codigo;?>" method="post" role="form">
                        <div class="box-body">
                            <div id="" class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="fname">Nro de Serie</label>
                                        <input require type="text" class="form-control required" id="serie" placeholder="Ingrese numero de serie" name="serie" maxlength="50" value="<?php echo $equipo->numero_serie; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Descripción</label>
                                        <textarea maxlength="150" class="form-control" style="resize:none" rows="1" id="descripcion" name="descripcion"> <?php echo $equipo->descripcion; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div id="" class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="host" placeholder="Ingrese nombre del host" name="host" maxlength="50" value="<?php echo $equipo->host; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Número de Servicio</label>
                                        <input type="text" class="form-control" id="servicio" placeholder="Ingrese número de servicio" name="servicio" maxlength="50" value="<?php echo $equipo->servicio; ?>">
                                    </div>
                                </div>
                            </div>
                            <div id="" class="row">
                                        ...
                                        <select class="form-control custom-select" id="proveedor_select" name="proveedor_select">
                                            ...
                                            if (!empty($proveedor)) {
                                                foreach ($proveedor as $pro) {
                                                    if ($pro->codigo==$equipo->codigo_proveedor) 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="fecha" name="fecha" value="<?php echo $equipo->fecha; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="" class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control" id="garantia" placeholder="Ingrese la garantía en meses" name="garantia" value="<?php echo $equipo->garantia; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Expediente</label>
                                        <input type="text" class="form-control" id="expediente" placeholder="Ingrese el número de expediente" name="expediente" value="<?php echo $equipo->expediente; ?>">
                                    </div>
                                </div>
                            </div>
