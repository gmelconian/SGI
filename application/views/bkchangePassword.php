<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cambiar contraseña
        <small>Seleccione nueva contraseña</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Igrese Detalle</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="<?php echo base_url() ?>changePassword" method="post">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="inputPassword1">Contrseña anterior</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="inputPassword1">Contreseña nueva</label>
